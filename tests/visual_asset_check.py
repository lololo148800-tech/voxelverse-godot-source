...
with Image.open(ATLAS) as image:
    if image.size != (128, 64) or image.mode not in {"RGB", "RGBA"}:
...
print("VISUAL_ASSET_PASS atlas=128x64 uv_mapping=true surface_sky=true guide_scroll=true compact_hud=true textless_gameplay_hud=true mobile_overlay=true mobile_actions=true starter_clearing=true echo_copy=true legacy_text_wall_hidden=true")
