...
func _v2_texture_tile(tile_index: int) -> Vector2i:
    var safe_index := clampi(tile_index, 1, 100) - 1
    return Vector2i(safe_index % 16, safe_index / 16)

func _texture_tile_for_block(block_type: int, face_index: int = 0) -> Vector2i:
    if ore_definitions.has(block_type):
        return _v2_texture_tile(21 + ((block_type - ORE_BLOCK_BASE) % 15))
    match block_type:
        GRASS:
            return _v2_texture_tile(1 if face_index == 0 else (3 if face_index == 1 else 2))
        DIRT: return _v2_texture_tile(3)
        STONE: return _v2_texture_tile(4)
        WOOD:
            return _v2_texture_tile(37 if face_index == 0 or face_index == 1 else 36)
        PLANKS: return _v2_texture_tile(38)
        LEAVES: return _v2_texture_tile(39)
        GLOW: return _v2_texture_tile(31)
        SAND: return _v2_texture_tile(7)
        SNOW: return _v2_texture_tile(11)
        CRYSTAL: return _v2_texture_tile(30)
        ASH: return _v2_texture_tile(19)
        WHISPER_SOIL: return _v2_texture_tile(15)
        MOSS: return _v2_texture_tile(14)
        SALT_CRUST: return _v2_texture_tile(6)
        EMBER: return _v2_texture_tile(20)
        WATER: return _v2_texture_tile(91)
        ASH_FLUID: return _v2_texture_tile(92)
        COSMIC_STONE: return _v2_texture_tile(18)
        ASTRAL_CRYSTAL, ARCANE_CRYSTAL: return _v2_texture_tile(33)
        DEEP_CRYSTAL: return _v2_texture_tile(30)
        WHISPER_BARK: return _v2_texture_tile(47)
        WHISPER_SHARD: return _v2_texture_tile(33)
        ASTRAL_METAL: return _v2_texture_tile(73)
        COSMIC_ICE: return _v2_texture_tile(12)
        VOID_SHARD: return _v2_texture_tile(18)
        ANTIMATTER: return _v2_texture_tile(73)
        NEBULA_GAS: return _v2_texture_tile(91)
        FURNITURE_CRATE, FURNITURE_TABLE: return _v2_texture_tile(38)
        FURNITURE_LAMP: return _v2_texture_tile(31)
        ARCANE_CONDUIT: return _v2_texture_tile(30)
        AUTOMATION_FORGE: return _v2_texture_tile(69)
        CARGO_RAIL: return _v2_texture_tile(73)
        _ : return _v2_texture_tile(4)
